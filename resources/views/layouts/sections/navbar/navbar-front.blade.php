    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4 me-xl-8">
        ...
        <a href="{{url('/')}}" class="app-brand-link">
          ...
          <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">PPG E-Learning</span>
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{url('/')}}#landingFeatures">Fitur</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{url('/')}}#landingContact">Hubungi</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{url('/admin/dashboard')}}" target="_blank">Admin</a>
          </li>
        </ul>
      </div>
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- navbar button: Start -->
        <li>
          <a href="{{url('/auth/login')}}" class="btn btn-primary" ><span class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login/Register</span></a>
        </li>
        <!-- navbar button: End -->
      </ul>
      <!-- Toolbar: End -->
