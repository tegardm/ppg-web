...
Route::get('/admin/dashboard', [AcademyDashboard::class, 'index'])->name('admin-academy-dashboard');
Route::get('/admin/course', [AcademyCourse::class, 'index'])->name('admin-academy-course');
Route::get('/admin/course-details', [AcademyCourseDetails::class, 'index'])->name('admin-academy-course-details');
